...
const CardItem = memo(({ item }: props) => {
  ...
  return (
    <div className="w-full border border-[#FFFFFF33] bg-cover backdrop-blur-2xl h-full overflow-hidden relative gap-4 p-4 rounded-3xl flex flex-row" style={gradientBorderStyle}>
      ...
      <div className="relative w-1/2">
        <img className="w-full h-full object-conver" src={item.path} alt="iamge" />
